	...
	this.frame_0 = function() {
		...
		(function () {
		  ...
		  function buildPanel(){
		    ...
		    ui.displayW = SR("Display Width (px)", 100, 2000, 10, DISPLAY_WIDTH, v=>(v|0)+" px", function(v){
		      DISPLAY_WIDTH = clamp(v|0, 100, 2000);
		      applyDisplayWidth(DISPLAY_WIDTH);
		    });
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/pi_atlas_1.png?1758157332688", id:"pi_atlas_1"}
	],
	preloads: []
};
