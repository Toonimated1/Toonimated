...
if (reversed == null) { reversed = false; }
	...
	this.instance_4.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(-63, 0, 0, -143))];
	...
	this.instance_5.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(-100, 0, 3, -144))];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(-63, 0, 0, -143))];
	...
	this.instance_1.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(-100, 0, 3, -144))];
...
if (reversed == null) { reversed = false; }
	...
	this.instance_4 = new lib.Symbol2();
	this.instance_4.setTransform(149.95,137.4,1,1,0,0,0,0,4.7);
	this.instance_4.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(-43, 0, -48, 171))];
	this.instance_4.cache(-142,-129,283,258);

	this.instance_5 = new lib.Symbol1();
	this.instance_5.setTransform(149.95,150);
	this.instance_5.shadow = new cjs.Shadow("rgba(0,0,0,0.247)",0,11,0);
	this.instance_5.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(-89, -59, 0, 168))];
	this.instance_5.cache(-152,-152,304,304);
...
if (reversed == null) { reversed = false; }
	...
	this.instance = new lib.Symbol2();
	this.instance.setTransform(149.95,137.4,1,1,0,0,0,0,4.7);
	this.instance.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(-43, 0, -48, 171))];
	this.instance.cache(-142,-129,283,258);

	this.instance_1 = new lib.Symbol1();
	this.instance_1.setTransform(149.95,150);
	this.instance_1.shadow = new cjs.Shadow("rgba(0,0,0,0.247)",0,11,0);
	this.instance_1.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(-89, -59, 0, 168))];
	this.instance_1.cache(-152,-152,304,304);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_4.setTransform(149.95,137.4,1,1,0,0,0,0,4.7);
	this.instance_4.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(-28, 0, -64, 0))];
	this.instance_4.cache(-142,-129,283,258);
	...
	this.instance_5.setTransform(149.95,150);
	this.instance_5.shadow = new cjs.Shadow("rgba(0,0,0,0.247)",0,11,0);
	this.instance_5.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(-73, 0, -64, 0))];
	this.instance_5.cache(-152,-152,304,304);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(149.95,137.4,1,1,0,0,0,0,4.7);
	this.instance.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(-28, 0, -64, 0))];
	this.instance.cache(-142,-129,283,258);
	...
	this.instance_1.setTransform(149.95,150);
	this.instance_1.shadow = new cjs.Shadow("rgba(0,0,0,0.247)",0,11,0);
	this.instance_1.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(-73, 0, -64, 0))];
	this.instance_1.cache(-152,-152,304,304);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		/*
		  --- NEW Helper: tweenWithTrail ---
		  Tweens an instance to new target properties while leaving a ghost trail behind.
		  If the instance is not actually moving (i.e. its current value matches targetProps)
		  then no ghost trail is created.
		*/
		function tweenWithTrail(instance, targetProps, duration, ease, onComplete) {
		  // Determine if there is any movement.
		  var moving = false;
		  if (targetProps.x !== undefined && instance.x !== targetProps.x) moving = true;
		  if (targetProps.y !== undefined && instance.y !== targetProps.y) moving = true;
		  
		  if (!moving) {
		    // No movement: simply tween normally.
		    createjs.Tween.get(instance).to(targetProps, duration, ease).call(function() {
		  ...
		  var intervalId = setInterval(function(){
		    // Clone the instance to create a ghost trail.
		    var ghost = instance.clone();
		    ghost.alpha = 0.05;
		    ghost.x = instance.x;
		    ghost.y = instance.y;
		    stage.addChild(ghost);
		    // Fade out the ghost and remove it.
		    createjs.Tween.get(ghost).to({ alpha: 0 }, 300).call(function(){
		...
		/*
		  ...
		  - As it finds contiguous groups (with group length ≥ 3), it calculates the reward
		    and collects match messages.
		  - NEW: If a group of 4 or more blocks is found, mark the color for a global board clear.
		*/
		var clearColors = []; // Global array for colors to be cleared from the board
		    ...
		    while (k < j) {
		      ...
		      if (groupLength >= 3) {
		         ...
		         if (color === "red" || color === "yellow" || color === "blue") {
		           reward = (groupLength === 3 ? 50 : 100);
		           if (groupLength >= 4) {
		             message = "NICE!";
		             if (clearColors.indexOf(color) === -1) {
		               clearColors.push(color);
		             }
		           }
		         } else if (color === "grey") {
		           reward = (groupLength === 3 ? 250 : 500);
		           if (groupLength >= 4) {
		             message = "AMAZING!";
		             if (clearColors.indexOf(color) === -1) {
		               clearColors.push(color);
		           ...
		           reward = (groupLength === 3 ? 1000 : 2000);
		           if (groupLength >= 4) {
		             message = "INCREDIBLE!";
		             if (clearColors.indexOf(color) === -1) {
		               clearColors.push(color);
		...
		/* --- NEW: showMatchMessage ---
		   Displays a match message along with bonus points.
		   If obj.text is nonempty, the message appears as "MESSAGE (+reward)".
		   Otherwise it shows just "(+reward)" below the Score.
		*/
		...
		/* --- NEW: animateShakeEffect ---
		   Applies a subtle staggered shake to all pieces when no move occurs.
		   Each block’s animation lasts 200ms with a slight random delay (0–20ms).
		*/
		...
		/*
		  ...
		  Spawns a new piece (or blocker) based on current score ranges.
		  NEW: Accepts an optional parameter swipeDir to determine the spawn edge.
		*/
		function addRandomBlockAnimated(swipeDir) {
		  ...
		  if (score < 500) {
		    ...
		    ["red", "yellow", "blue"].forEach(function(c){ blockerChanceMapping[c] = 0.3; });
		    blockerChanceMapping["grey"] = 0;
		  } else if (score < 4000) {
		    allowedColors = ["red", "yellow", "blue", "grey"];
		    allowedColors.forEach(function(c){ blockerChanceMapping[c] = 0.3; });
		  } else if (score < 10000) {
		    allowedColors = ["red", "yellow", "blue", "grey", "black"];
		    ["red", "yellow", "blue", "grey"].forEach(function(c){ blockerChanceMapping[c] = 0.3; });
		    blockerChanceMapping["black"] = 0;
		  } else if (score < 20000) {
		    allowedColors = ["red", "yellow", "blue", "grey", "black"];
		    allowedColors.forEach(function(c){ blockerChanceMapping[c] = 0.3; });
		  } else {
		  ...
		  // If a swipe direction is provided, restrict empty cells to the edge opposite that swipe.
		  if (swipeDir) {
		  ...
		  var spawnBlocker = (Math.random() < chance);
		  var instance;
		  if (spawnBlocker) {
		...
		/* animateRowSwipe: Animate one row swipe (left/right)
		   Modified to use tweenWithTrail so that a ghost trail is only created for moving pieces.
		*/
		function animateRowSwipe(rowIndex, direction, onLineComplete) {
		  ...
		  result.mapping.forEach(function(map) {
		    ...
		    tweenWithTrail(block.instance, { x: newX }, 200, createjs.Ease.quadIn, function() {
		      if (map.vanish) {
		...
		*/
		function animateColumnSwipe(colIndex, direction, onLineComplete) {
		  ...
		  result.mapping.forEach(function(map) {
		    ...
		    tweenWithTrail(block.instance, { y: newY }, 200, createjs.Ease.quadIn, function() {
		      if (map.vanish) {
		        createjs.Tween.get(block.instance).to({ alpha: 0 }, 200).call(function() {
		          stage.removeChild(block.instance);
		        });
		...
		/* animateHorizontalSwipe: Animate horizontal swipe with 10ms stagger per row.
		   Accumulates rewards from each row swipe and shows one combined message.
		*/
		...
		/* animateVerticalSwipe: Animate vertical swipe with 10ms stagger per column.
		   Accumulates rewards from each column swipe and shows one combined message.
		*/
		...
		function init() {
		  ...
		  // --- NEW: High Score Display (renamed from Top Score) ---
		  ...
		  animateBoardLightUp(function() {
		    addRandomBlockAnimated(); // Initial spawn, no swipe direction needed.
		  });
		  ...
		  animateHorizontalSwipe("left", function(moved) {
		    if (moved) {
		      setTimeout(function() {
		        if (boardCleared()) {
		          score += 5000;
		          showMatchMessage({ text: "", reward: 5000 });
		        }
	...
	this.dithering.setTransform(-3126.45,-447.45);
...
p.nominalBounds = new cjs.Rectangle(-2126.4,552.6,4490.9,1737.6);
// library properties:
lib.properties = {
