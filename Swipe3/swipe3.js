...
// stage content:
(lib.swipe3_2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		var topScore = 100000;      // Default top score is 30,000
		...
		/*
		  ...
		  - When a contiguous group of 3 or more is found:
		      • For a group of 4 or more, trigger a super clear.
		        (Reward is set to 0 here so the swipe callback adds exactly 3000.)
		...
		*/
		...
		/*
		  ...
		  Spawns a new piece (or blocker) based on the current score thresholds.
		  Blocker chance rules:
		    • For score < 500: allowedColors = [red, yellow, blue] with 0% chance.
		    • For score 500–1000: allowedColors = [red, yellow, blue] with 0% chance.
		    • For score 1001–2000: allowedColors = [red, yellow, blue] with 10% chance.
		    • For score 2001–4000: allowedColors = [red, yellow, blue, grey] with 15% chance.
		    • For score 4001–10000: allowedColors = [red, yellow, blue, grey, black] with 15% chance.
		    • For score 10001–20000 (and above): allowedColors = [red, yellow, blue, grey, black] with 20% chance.
		  
		  Additionally:
		    • If the board is completely empty (after a super clear), force a non‑blocker.
		    • If there are only 1 or 2 empty cells, force a blocker.
		*/
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/swipe3_atlas_1.png?1743122643696", id:"swipe3_atlas_1"}
	],
	preloads: []
};
