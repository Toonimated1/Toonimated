	...
	this.frame_0 = function() {
		    ...
		    while (k < j) {
		      ...
		      if (groupLength >= 3) {
		         ...
		         if (color === "red" || color === "yellow" || color === "blue") {
		           ...
		           if(groupLength === 4) message = "NICE!";
		         } else if (color === "grey") {
		           reward = (groupLength === 3 ? 250 : 500);
		           if(groupLength === 3) message = "GREAT!";
		           else if(groupLength === 4) message = "AMAZING!";
		         } else if (color === "black") {
		           reward = (groupLength === 3 ? 1000 : 2000);
		           if(groupLength === 3) message = "AWESOME!!";
		           else if(groupLength === 4) message = "INCREDIBLE!";
		         }
		         // Accumulate reward for this matching group
		         scoreInc += reward;
		...
		*/
		function showMatchMessage(obj) {
		  ...
		  // Lower the message further down from the score
		...
		*/
		function animateRowSwipe(rowIndex, direction, onLineComplete) {
		  ...
		  if (result.matchMessages && result.matchMessages.length > 0) {
		    ...
		    // Do not show message here; reward will be accumulated by the swipe function.
		  }
		  if (!result.changed) {
