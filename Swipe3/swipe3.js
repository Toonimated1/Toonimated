...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		//---------------------------------------------------------------------
		// resizeCanvas: Adjust the canvas resolution for high DPI displays.
		//---------------------------------------------------------------------
		function resizeCanvas() {
		    var canvas = document.getElementById("canvas");
		    var dpr = window.devicePixelRatio || 1;
		    // Define the logical width and height.
		    // The board is 4 cells wide (4 x 300 = 1200) and 4 cells tall (4 x 300 = 1200) plus 50px for score.
		    var logicalWidth = boardCols * cellSize;   // 1200px
		    var logicalHeight = boardRows * cellSize + 50; // 1200 + 50 = 1250px
		
		    // Set the canvas resolution (width and height attributes) to the logical size multiplied by dpr.
		    canvas.width = logicalWidth * dpr;
		    canvas.height = logicalHeight * dpr;
		    // Set the CSS style size to the logical size.
		    canvas.style.width = logicalWidth + "px";
		    canvas.style.height = logicalHeight + "px";
		
		    // If stage exists, scale it accordingly.
		    if (stage) {
