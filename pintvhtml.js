...
lib.ssMetadata = [
		{name:"pintvhtml_atlas_1", frames: [[0,0,182,182]]}
];
...
(lib.hexmaze = function() {
	this.initialize(ss["pintvhtml_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.hexmaze();
	this.instance.setTransform(172,92,1.6374,1.6374);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(15));

	// Layer_1
	this.instance_1 = new lib.Symbol1();
	this.instance_1.setTransform(319.2,238.25,1,1,0,0,0,73.2,73.2);
	this.instance_1.shadow = new cjs.Shadow("rgba(255,0,0,1)",0,0,110);
	new cjs.ButtonHelper(this.instance_1, 0, 1, 2, false, new lib.Symbol1(), 3);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({rotation:45.2673,x:319.15,y:238.2},0).wait(1).to({rotation:90.6432,x:319.2,y:238.25},0).wait(1).to({rotation:134.2337},0).wait(1).to({rotation:174.485,x:319.15},0).wait(1).to({rotation:210.4527,x:319.2},0).wait(1).to({rotation:241.7921,x:319.15},0).wait(1).to({rotation:268.5842,x:319.2,y:238.2},0).wait(1).to({rotation:291.1454,x:319.15,y:238.25},0).wait(1).to({rotation:309.887},0).wait(1).to({rotation:325.234,x:319.2},0).wait(1).to({rotation:337.5849,x:319.15,y:238.2},0).wait(1).to({rotation:347.2961},0).wait(1).to({rotation:354.6784,x:319.2,y:238.25},0).wait(1).to({rotation:360},0).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/pintvhtml_atlas_1.png?1741504567624", id:"pintvhtml_atlas_1"}
	],
	preloads: []
};
