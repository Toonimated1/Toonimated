...
lib.ssMetadata = [
    {name:"oliTEST_atlas_1", frames: [[0,0,1620,1358]]},
    {name:"oliTEST_atlas_2", frames: [[0,0,800,806]]}
];
...
(lib.cerberus_high_inv = function() {
    this.initialize(ss["oliTEST_atlas_1"]);
    this.gotoAndStop(0);
...
(lib.Oliver_expressions_concerned_talk = function() {
    this.initialize(ss["oliTEST_atlas_2"]);
    this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
p.frameBounds = [
  ...
  rect,
  rect,
  new cjs.Rectangle(-2,-3,411,348),
  new cjs.Rectangle(-2,-4,411,350),
  new cjs.Rectangle(-2,-5,411,352),
  new cjs.Rectangle(-2,-6,411,354),
  new cjs.Rectangle(-2,-7,411,356),
  rect,
  new cjs.Rectangle(-4,-16,419,378),
  new cjs.Rectangle(-2,-8,411,358),
  new cjs.Rectangle(-2,-7,411,356),
  new cjs.Rectangle(-2,-6,411,354),
  new cjs.Rectangle(-2,-5,411,352),
  new cjs.Rectangle(-2,-4,411,350),
  new cjs.Rectangle(-2,-3,411,348),
  rect,
  new cjs.Rectangle(-2,-2,411,346),
  rect,
  new cjs.Rectangle(0,0,403.7,338.4)
];
    ...
    this.frame_0 = function() {
        ...
        function applyBayer8x8_32color() {
          ...
          for (var i = 0; i < data.length; i += 4) {
            ...
            var scaled = offset * (255 / 63) * 0.5; // tweak *0.5 for more/less dithering
...
p.frameBounds = [rect, rect, rect, rect, rect,
 new cjs.Rectangle(254,339.3,835.6,680.4),
 new cjs.Rectangle(254,333.8,835.6,685.9),
 new cjs.Rectangle(254,328.3,835.6,691.4),
 new cjs.Rectangle(254,322.9,835.6,696.8),
 new cjs.Rectangle(254,317.4,835.6,702.3),
 new cjs.Rectangle(254,312,835.6,707.7),
 new cjs.Rectangle(254,285.5,835.6,734.2),
 new cjs.Rectangle(254,310.5,835.6,709.2),
 new cjs.Rectangle(254,314.5,835.6,705.2),
 new cjs.Rectangle(254,318.5,835.6,701.2),
 new cjs.Rectangle(254,322.5,835.6,697.2),
 new cjs.Rectangle(254,326.5,835.6,693.2),
 new cjs.Rectangle(254,330.5,835.6,689.2),
 new cjs.Rectangle(254,334.5,835.6,685.2),
 new cjs.Rectangle(254,338.5,835.6,681.2),
 rect,
 rect,
 rect,
 rect,
...
lib.properties = {
    ...
    manifest: [
        {
          src:"https://raw.githubusercontent.com/Toonimated1/Toonimated/main/images/cerberus_high_inv.png",
          id:"oliTEST_atlas_1"
        },
        {
          src:"https://raw.githubusercontent.com/Toonimated1/Toonimated/main/images/Oliver_expressions_concerned_talk.png",
          id:"oliTEST_atlas_2"
        }
    ],
    // --------------------------------------------------
        ...
        if(target){
            if(target.filterCacheList){
                for(var index = 0; index < target.filterCacheList.length ; index++){
                    ...
                    if((cacheInst.startFrame <= target.currentFrame) && 
                       (target.currentFrame <= cacheInst.endFrame)){
                        cacheInst.instance.cache(cacheInst.x, cacheInst.y, 
                                                 cacheInst.w, cacheInst.h);
                    }
                }
            }
        }
