...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		// ----- (Removed Hover Panning) -----
		// For web, hover-based panning has been removed as per your request.
	...
	this.Panorama.setTransform(0,0.05,0.9005,0.9005,0,0,0,-1567,-2062);
...
p.nominalBounds = rect = new cjs.Rectangle(300,300,2821.9,3714.2);
p.frameBounds = [rect];
// library properties:
lib.properties = {
