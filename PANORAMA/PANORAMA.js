...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.lf(["#FF0000","#FFFF00","#00FF00","#00FFFF","#0000FF","#FF00FF","#FF0000"],[0,0.165,0.365,0.498,0.667,0.831,1],-1755.1,0,1755.2,0).s().p("EkSPEieMAAApE7MIkfAAAMAAAJE7g");
	this.shape.setTransform(1729.275,1852.575);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Panorama, new cjs.Rectangle(-25.9,-6.4,3510.4,3718), null);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		// Use CreateJS event model for both touch and mouse
		...
		// Ensure canvas resizing works on mobile too
	...
	this.Panorama.setTransform(598.15,744.45,1.5556,1.5556,0,0,0,358.6,472.1);
	this.Panorama.filters = [new cjs.BlurFilter(4, 4, 3), new cjs.ColorMatrixFilter(new cjs.ColorMatrix(-99, 0, 68, 0))];
	this.Panorama.cache(-28,-8,3514,3722);
...
p.nominalBounds = new cjs.Rectangle(394,394,5076,5399);
// library properties:
lib.properties = {
