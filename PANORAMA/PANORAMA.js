...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		// Make sure to check if you're using cacheAsBitmap and disable it if unnecessary
		panorama.cache(0, 0, boundsWidth, boundsHeight); // Cache only the necessary area if needed, but avoid caching for animated objects
		...
		createjs.Ticker.on("tick", () => {
		    ...
		    // If you have caching applied, update it only when needed:
		    // panorama.updateCache(); 
