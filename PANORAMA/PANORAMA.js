...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		// CreateJS event model for both mouse and touch
		...
		// [A] Retro settings: use a fixed retro width and calculate the height proportionally
		var retroWidth = 384;
