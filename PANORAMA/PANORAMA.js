...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		const boundsWidth = 2000;  // Updated from 4000 to 2000
		const boundsHeight = 2632.4; // Unchanged; adjust if necessary
		...
		var retroWidth = 256;  // Lower resolution for a coarser effect
	...
	this.instance.setTransform(301.5,297.55);
...
p.nominalBounds = rect = new cjs.Rectangle(300,300,2003,2636);
p.frameBounds = [rect];
// library properties:
lib.properties = {
