...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF0000").s().p("");
	this.shape.setTransform(2011.875,2864.375);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer_1
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.bf(img.Bitmap2, null, new cjs.Matrix2D(5.571,0,0,5.571,-2000,-2632.3)).s().p("Ek4fGbTMAAAs2lMJw/AAAMAAAM2lg");
	this.shape_1.setTransform(2000,2632.275);
