...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0},147).to({_off:true},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = rect = new cjs.Rectangle(-301.5,-297.5,603.1,595.1);
p.frameBounds = [rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, null];
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		// Scaled panorama bounds (image width changed from 4000 to 2000)
		const boundsWidth = 2000;  // Updated width
		const boundsHeight = 2632.4; // Unchanged height; update if needed
		...
		const moveDrag = (e) => {
		    if (dragging) {
		        ...
		        let deltaX = x - startX;
		        let deltaY = y - startY;
		        // For mobile, increase the drag movement for better responsiveness
		        if (isMobile) {
		...
		// Hover-based panning has been removed per your instructions.
		
		// ----- Additional Mobile Touch Support -----
		// In addition to CreateJS events, add native touch listeners for improved mobile responsiveness.
		if (isMobile) {
		...
		// [A] Retro settings: use a lower retro width for a coarser dithering effect
		var retroWidth = 256;  // Lower resolution for a more pixelated effect
		...
		// ----- Throttled Dithering for Performance -----
		// On mobile devices, update dithering every 100ms instead of every tick.
		var lastDitherTime = 0;
		var ditherInterval = isMobile ? 100 : 0; // 100ms on mobile; 0ms on desktop
		
		// ----- Master Ticker -----
		// This function combines timeline advancement, panorama smoothing, stage updating, and throttled dithering.
		function handleMasterTick(evt) {
		  ...
		  // Throttle dithering updates on mobile for better performance
		  var now = Date.now();
		  if (now - lastDitherTime >= ditherInterval) {
		      lastDitherTime = now;
	...
	this.instance.setTransform(301.5,297.55,1,1.0307);
...
p.nominalBounds = rect = new cjs.Rectangle(300,290.9,2003,2645.2);
p.frameBounds = [rect];
// library properties:
lib.properties = {
